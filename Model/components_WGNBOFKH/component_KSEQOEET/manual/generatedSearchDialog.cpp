// -*- C++ -*- generated by wxGlade 0.5 on Mon Dec 22 21:09:52 2008 from C:\Dokumente und Einstellungen\Thomas\Eigene Dateien\Astade\Model\components_WGNBOFKH\component_KSEQOEET\manual\dialogs.wxg
    ...
    wxDialog(parent, id, title, pos, size, wxDEFAULT_DIALOG_STYLE)
{
    ...
    TextToFind = new wxTextCtrl(this, ID_TextToFind, wxEmptyString);
...
void generatedSearchDialog::set_properties()
{
    ...
    SetTitle(wxT("search"));
    ScopeActiveComponent->SetValue(1);
