// -*- C++ -*- generated by wxGlade 0.5 on Tue Dec 30 09:31:27 2008 from C:\Dokumente und Einstellungen\Thomas\Eigene Dateien\Astade\Model\components_WGNBOFKH\component_KSEQOEET\manual\dialogs.wxg
...
public:
    ...
    enum {
        ...
        ID_LookingForComponent = wxID_HIGHEST + 1004,
        ID_LookingForUserCode = wxID_HIGHEST + 1005,
        ...
        ID_LookingForAll = wxID_HIGHEST + 1012,
        ID_FieldsToSearchName = wxID_HIGHEST + 1013,
        ID_FieldsToSearchType = wxID_HIGHEST + 1014,
        ID_FieldsToSearchDefault = wxID_HIGHEST + 1015,
        ID_FieldsToSearchUserCode = wxID_HIGHEST + 1016,
        ID_FieldsToSearchDescription = wxID_HIGHEST + 1017,
        ID_FieldsToSearchAll = wxID_HIGHEST + 1018,
        ID_Cancel = wxID_HIGHEST + 1019,
