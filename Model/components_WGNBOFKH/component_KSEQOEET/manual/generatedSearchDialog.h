// -*- C++ -*- generated by wxGlade 0.5 on Fri Dec 26 09:02:06 2008 from C:\Dokumente und Einstellungen\Thomas\Eigene Dateien\Astade\Model\components_WGNBOFKH\component_KSEQOEET\manual\dialogs.wxg
...
public:
    ...
    enum {
        ...
        ID_LookingForClass = wxID_HIGHEST + 1004,
        ID_LookingForAttribute = wxID_HIGHEST + 1005,
        ID_LookingForOperation = wxID_HIGHEST + 1006,
        ID_LookingForParameter = wxID_HIGHEST + 1007,
        ID_LookingForType = wxID_HIGHEST + 1008,
        ID_LookingForState = wxID_HIGHEST + 1009,
        ID_LookingForUserCode = wxID_HIGHEST + 1010,
        ID_LookingForAll = wxID_HIGHEST + 1011,
        ID_FieldsToSearchName = wxID_HIGHEST + 1012,
        ID_FieldsToSearchType = wxID_HIGHEST + 1013,
        ID_FieldsToSearchDefault = wxID_HIGHEST + 1014,
        ID_FieldsToSearchUserCode = wxID_HIGHEST + 1015,
        ID_FieldsToSearchDescription = wxID_HIGHEST + 1016,
        ID_FieldsToSearchAll = wxID_HIGHEST + 1017,
        ID_Cancel = wxID_HIGHEST + 1018,
        ID_StartSearch = wxID_HIGHEST + 1019
    };
    // end wxGlade
