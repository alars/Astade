...
if (CmdLineParser.Parse() == 0)
{
	if (CmdLineParser.GetParamCount() == 2)
	{
	    ...
	    fprintf(implementationFile, "/* this code was generated by the Astade StateChartCoderVSM */\n");
	    fprintf(implementationFile, "/**\n");
	    ...
	    fprintf(specificationFile, "/* this code was generated by the Astade StateChartCoderVSM */\n");
	    fprintf(specificationFile, "/**\n");
