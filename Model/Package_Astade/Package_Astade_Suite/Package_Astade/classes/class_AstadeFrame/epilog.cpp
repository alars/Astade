BEGIN_EVENT_TABLE(AstadeFrame,wxFrame)
    ...
    EVT_MENU(ID_DOWN, AstadeFrame::MoveDown)
    EVT_MENU(ID_UP, AstadeFrame::MoveUp)
    ...
    EVT_MENU(ID_RENAMEELEMENTS, AstadeFrame::RenameRecursively)
    ...
    EVT_MENU(ID_COMPOSITESTRUCTUREDIAGRAM, AstadeFrame::DisplayCompositeStructure)
    ...
    EVT_MENU(ID_SELECTHG, AstadeFrame::SelectRepository)
    ...
    EVT_MENU(ID_STOP_BUILD, AstadeFrame::OnStopBuild)
