...
relations->Add(new wxStaticText(this, 0, wxS("Trigger:"), wxDefaultPosition, wxSize(50, 15)), 0);
...
relations->Add(new wxStaticText(this, 0, wxS("Guard:"), wxDefaultPosition, wxSize(50, 15)), 0);
