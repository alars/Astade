...
box->Add(new wxStaticText(this, -1, wxS("Event type:"), wxDefaultPosition, wxSize(60,15)));
...
box->Add(new wxStaticText(this, -1, wxS("Coder suffix:"), wxDefaultPosition, wxSize(80,15)),0,wxLEFT,10);
...
box->Add(new wxStaticText(this, -1, wxS("Initial state:"), wxDefaultPosition, wxSize(60,15)));
