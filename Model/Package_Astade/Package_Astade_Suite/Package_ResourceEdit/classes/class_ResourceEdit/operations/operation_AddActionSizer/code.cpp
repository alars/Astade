...
box->Add(new wxStaticText(this, -1, wxS("Action 2:"), wxDefaultPosition, wxSize(70,15)), 0, wxLEFT, 10);
...
box->Add(new wxStaticText(this, -1, wxS("Action 3:"), wxDefaultPosition, wxSize(70,15)));
...
box->Add(new wxStaticText(this, -1, wxS("Action 4:"), wxDefaultPosition, wxSize(70,15)), 0, wxLEFT, 10);
