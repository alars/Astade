...
if (is)
{
	wxBoxSizer* box = new wxStaticBoxSizer( new wxStaticBox(this, -1, wxString(wxS("Class include:"))), wxHORIZONTAL );
...
{
	wxBoxSizer* box = new wxStaticBoxSizer( new wxStaticBox(this, -1, wxString(wxS("Additional base classes:"))), wxHORIZONTAL );
