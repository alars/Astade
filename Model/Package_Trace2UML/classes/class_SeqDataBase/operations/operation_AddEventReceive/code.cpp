//~~ void AddEventReceive(int object1, int object2, const wxString& label, const wxString& timeStamp) [SeqDataBase] ~~
...
if (object1 == wxNOT_FOUND)
	itsEvents.push_back(SeqEvent(object1,object2,ID_GLOBALRECEIVE,s.Trim(true).Trim(false),timeStamp));
