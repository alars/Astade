BEGIN_EVENT_TABLE(AstadeFrame,wxFrame)
	...
	EVT_MENU(ID_ADDATTRIBUTES, AstadeFrame::AddSubElement)
	EVT_MENU(ID_ADDATTRIBUTE, AstadeFrame::AddSubElement)
	EVT_MENU(ID_ADDCLASSES, AstadeFrame::AddSubElement)
	EVT_MENU(ID_ADDCLASS, AstadeFrame::AddSubElement)
	EVT_MENU(ID_ADDLIBCLASS, AstadeFrame::AddSubElement)
	EVT_MENU(ID_ADDCOMPONENTFOLDER, AstadeFrame::AddSubElement)
	EVT_MENU(ID_ADDCOMPONENT, AstadeFrame::AddSubElement)
	EVT_MENU(ID_ADDCONFIGURATION, AstadeFrame::AddSubElement)
	EVT_MENU(ID_ADDCONSTRUCTOR, AstadeFrame::AddSubElement)
	EVT_MENU(ID_ADDDESTRUCTOR, AstadeFrame::AddSubElement)
	EVT_MENU(ID_ADDOPERATIONS, AstadeFrame::AddSubElement)
	EVT_MENU(ID_ADDOPERATION, AstadeFrame::AddSubElement)
	EVT_MENU(ID_ADDRELATION, AstadeFrame::AddRelation)
	EVT_MENU(ID_ADDTOCOMPONENT, AstadeFrame::AddToComponent)
	EVT_MENU(ID_ADDPACKAGE, AstadeFrame::AddSubElement)
	EVT_MENU(ID_ADDPARAMETERS, AstadeFrame::AddSubElement)
	EVT_MENU(ID_ADDPARAMETER, AstadeFrame::AddSubElement)
	...
	EVT_MENU(ID_ADDTYPES, AstadeFrame::AddSubElement)
	...
	EVT_MENU(ID_MAKECLEAN, AstadeFrame::CallMake)
	...
	EVT_MENU(ID_ADDSEQUENCES, AstadeFrame::AddSubElement)
