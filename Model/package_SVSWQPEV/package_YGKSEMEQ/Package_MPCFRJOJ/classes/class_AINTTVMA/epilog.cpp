BEGIN_EVENT_TABLE (CodeEditControl, wxStyledTextCtrl)
    ...
    EVT_MENU (myID_INDENTINC,          CodeEditControl::OnEditIndentInc)
    EVT_MENU (myID_INDENTRED,          CodeEditControl::OnEditIndentRed)
    ...
    EVT_MENU (myID_LINENUMBER,         CodeEditControl::OnLineNumber)
